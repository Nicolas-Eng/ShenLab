...
save(specificity.heatmap, file=paste0(output.dir, "/", run.id, "/saved/specificity.heatmap.Rdata"))
print(paste0(output.dir, "/", run.id, "/saved/specificity.heatmap.Rdata"))
print('loading specificity heatmap')
load(paste0(output.dir, "/", run.id, "/saved/specificity.heatmap.Rdata"))
cell.types <- colnames(specificity.heatmap)
print(cell.types)
for (cell.type in cell.types) {
  specificity.heatmap.celltype <- specificity.heatmap[, cell.type]
  save(specificity.heatmap.celltype, file = paste0(output.dir, "/", run.id, "/saved/specificity.heatmap.", cell.type,'.Rdata', sep=""))
}
