...
dataset_name="epiLCs_H3K4me3_trim_ds_merged"
fastq_format=".fastq"
fastq_dir="/shen/shenlabstore3/neng/05152019_Blelloch_PLAC-seq/PLAC-seq_output/data/"
outdir="/wynton/scratch/neng/05152019_Blelloch_PLAC-seq/output"
#macs2_filepath="/wynton/scratch/neng/05152019_Blelloch_PLAC-seq/output/anchors_output/V6-5_GRHL2vsD12_GRHL2nomod200_q05merged_peaks.bed"
macs2_filepath="/wynton/scratch/neng/05152019_Blelloch_PLAC-seq/output/anchors_output/all_H3K4me3_merged.q1e-4.final_x.bed"
organism="mm10"
bwa_index=""
bin_size=5000
fdr=2
...
if [ $maps -eq 1 ]; then
	...
	echo "second"
	$Rscript_path $MAPS_path/MAPS_regression_and_peak_caller_mod.r $maps_output $dataset_name"."$resolution"k" $bin_size $chr_count $filter_file $model
