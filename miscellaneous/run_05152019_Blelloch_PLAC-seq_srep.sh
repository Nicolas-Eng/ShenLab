...
dataset_name="MS042_merged"
fastq_format=".fastq"
fastq_dir="/shen/shenlabstore3/neng/05152019_Blelloch_PLAC-seq/"
outdir="/scrapp/neng/05152019_Blelloch_PLAC-seq/output"
macs2_filepath="/scrapp/neng/05152019_Blelloch_PLAC-seq/output/feather_output/ChIP-seq_calling/anchors_H3K4me3/final_q1e-2.bed"
organism="mm10"
bwa_index=""
bin_size=5000
fdr=2
...
if [ $maps -eq 1 ]; then
	...
	echo "second"
	$Rscript_path $MAPS_path/MAPS_regression_and_peak_caller_srep.r $maps_output $dataset_name"."$resolution"k" $bin_size $chr_count $filter_file $model
