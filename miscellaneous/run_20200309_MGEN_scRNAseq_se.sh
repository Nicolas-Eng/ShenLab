...
trim_galore -q 20 --phred33 --gzip --length 20 --stringency 3 \
	--trim-n --output_dir /shen/shenlabstore3/neng/20200309_MGEN/scRNA_bulk/output/trimmed \
	/shen/shenlabstore3/neng/20200309_MGEN/scRNA_bulk/processed_SE/${file_prefix}_R1.fastq.gz

echo 'running star...'
STAR --genomeDir /shen/shenlabstore3/neng/reference_genome/hg19/rsem_star \
	--readFilesCommand zcat --readFilesIn \
	/shen/shenlabstore3/neng/20200309_MGEN/scRNA_bulk/output/trimmed/${file_prefix}_R1_trimmed.fq.gz \
	...
	/shen/shenlabstore3/neng/20200309_MGEN/scRNA_bulk/output/${file_prefix}. --outFilterType BySJout \
...
rsem-calculate-expression --bam --no-bam-output -p 8 --forward-prob 0 --estimate-rspd \
	/shen/shenlabstore3/neng/20200309_MGEN/scRNA_bulk/output/${file_prefix}.Aligned.toTranscriptome.out.bam \
	/shen/shenlabstore3/neng/reference_genome/hg19/rsem_star/hg19_gencode \
	/shen/shenlabstore3/neng/20200309_MGEN/scRNA_bulk/output/${file_prefix} >& \
	/shen/shenlabstore3/neng/20200309_MGEN/scRNA_bulk/output/${file_prefix}.rsem.log

echo 'preparing visualization files'

cd /shen/shenlabstore3/neng/20200309_MGEN/scRNA_bulk/output
mkdir visualization
