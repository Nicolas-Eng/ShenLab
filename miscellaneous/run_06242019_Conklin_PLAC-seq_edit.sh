...
dataset_name="WTC_0hr_trim_merged"
fastq_format=".fastq"
fastq_dir="/shen/shenlabstore3/neng/06242019_Conklin_PLAC-seq/WTC_0hr"
...
if [ $maps -eq 1 ]; then
	...
	echo "second"
	$Rscript_path $MAPS_path/MAPS_regression_and_peak_caller_edit.r $maps_output $dataset_name"."$resolution"k" $bin_size $chr_count $filter_file $model
